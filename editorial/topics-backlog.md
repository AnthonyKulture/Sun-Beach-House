# Topics backlog — Sun Beach House

Queue de sujets pour l'agent rédactionnel `sbh-editorial`. L'agent prend le premier sujet `[ ]` non coché, sauf si l'utilisateur en spécifie un autre.

Conventions :
- `[ ]` — à rédiger
- `[~]` — en cours
- `[x]` — publié (déplacer en bas dans "Archive")
- `(SAISON: oct-déc)` — fenêtre de publication recommandée

---

## Cibles de ranking primaires

Mots-clés que les articles doivent attaquer, par langue :

**FR**
- location villa saint barth
- location villa saint barthélemy
- villa luxe saint barth
- conciergerie saint barth
- vente villa saint barthélemy
- saint barth haute saison
- bucket regatta saint barth
- noël saint barth

**EN**
- villa rental st barth
- luxury villa saint barthélemy
- st barths concierge
- st barths high season
- st barths real estate
- bucket regatta st barth

**ES**
- alquiler villa san bartolomé
- villa lujo saint barth
- conserjería saint barth

**PT**
- aluguel villa saint barth
- villa luxo saint barthélemy
- concierge saint barth
...
|---|-----|------|-------|---------|-----------------|
| 1 | S1 | Lun | Saint-Barth en haute saison 2026-2027 : guide complet | `haute-saison-saint-barth-2026-2027` | haute saison saint barth |
| 2 | S1 | Jeu | Bucket Regatta 2027 : dates, parcours, comment réserver une villa à temps | `bucket-regatta-2027-villa-saint-barth` | bucket regatta 2027 villa |
| 3 | S2 | Lun | Noël à Saint-Barth : pourquoi réserver 6 à 12 mois à l'avance | `louer-villa-saint-barth-noel-reservation` | louer villa saint barth noël |
| 4 | S2 | Jeu | Gustavia : guide d'initié de la capitale de Saint-Barth | `gustavia-guide-saint-barth` | villa gustavia saint barth |
| 5 | S3 | Lun | Chef privé à Saint-Barth : tout ce qu'il faut savoir avant de réserver | `chef-prive-villa-saint-barth` | chef privé saint barth villa |
| 6 | S3 | Jeu | Pointe Milou : pourquoi les couchers de soleil les plus emblématiques | `pointe-milou-coucher-soleil-saint-barth` | villa pointe milou saint barth |
| 7 | S4 | Lun | Louer une villa à Saint-Barth : 5 questions à se poser avant de réserver | `5-questions-louer-villa-saint-barth` | comment choisir villa saint barth |
| 8 | S4 | Jeu | Mariage à Saint-Barthélemy : organiser un événement privé | `mariage-saint-barthelemy-organiser` | mariage saint barthélemy organiser |
| 9 | S5 | Lun | Saint-Barth sous la pluie : 8 choses à faire quand le ciel se couvre | `saint-barth-quand-il-pleut` | saint barth quand il pleut |
| 10 | S5 | Jeu | Une journée à Saint-Barth, par Valérie | `une-journee-saint-barth-par-valerie` | saint barth itinéraire journée |
...
- [x] #4 St Barth Cata Cup 2026 (retiré du calendrier — sujet déjà traité, remplacé par #7 sur le créneau du 20/08)
- [~] #5 Saint-Jean guide
...
## Backlog actif (après le Plan 2026-05)

Sujets disponibles une fois le Plan 2026-05 terminé.
...
- [x] St Barth Cata Cup 2026 : régate Formule 18 à Saint-Jean, 16-23 novembre (→ Plan 2026-08 #4 — retiré du calendrier, sujet déjà traité)
