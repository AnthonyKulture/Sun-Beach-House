...
interface SalesContactPageProps {
  inquiryParams: SalesInquiryParams;
  onBack: () => void;
}

export const SalesContactPage: React.FC<SalesContactPageProps> = ({ inquiryParams, onBack }) => {
  const { villa, loading } = useVilla(inquiryParams.villaId);
       ...
       <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-5 order-2 lg:order-1">
             <div className="sticky top-40 bg-sbh-cream/30 border border-gray-100 rounded-xl overflow-hidden p-6 md:p-8 shadow-xl shadow-gray-100/50">
                 ...
                 {/* Villa Mini Card */}
                 <div className="mb-8">
                    <div className="w-full h-48 rounded-lg overflow-hidden shrink-0 mb-6">
