      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-24">
            ...
            <div className="reveal-on-scroll" style={{ transitionDelay: '100ms' }}>
                <h4 className="font-sans text-sm font-bold uppercase tracking-[0.2em] text-sbh-sand mb-8 text-center md:text-left">Explorer</h4>
                <nav>
                    <ul className="space-y-4 font-serif text-lg md:text-xl text-sbh-cream/90 flex flex-col items-center md:items-start">
                        <li>
                            <button onClick={() => handleNav('home')} className="hover:text-sbh-blue hover:translate-x-2 transition-all duration-300 flex items-center gap-2">
                                Accueil
                            </button>
                        </li>
                        <li>
                            <button onClick={() => handleNav('collections')} className="hover:text-sbh-blue hover:translate-x-2 transition-all duration-300 flex items-center gap-2">
                                Collections
                            </button>
                        </li>
                        <li>
                            <button onClick={() => handleNav('destinations')} className="hover:text-sbh-blue hover:translate-x-2 transition-all duration-300 flex items-center gap-2">
                                Destination
                            </button>
                        </li>
                        <li>
                            <button onClick={() => handleNav('about')} className="hover:text-sbh-blue hover:translate-x-2 transition-all duration-300 flex items-center gap-2">
                                L'Esprit
                            </button>
                        </li>
                        <li>
                            <button onClick={() => handleNav('contact')} className="hover:text-sbh-blue hover:translate-x-2 transition-all duration-300 flex items-center gap-2">
                                Contact
                            </button>
                        </li>
                    </ul>
            ...
            <div className="reveal-on-scroll" style={{ transitionDelay: '200ms' }}>
                <h4 className="font-sans text-sm font-bold uppercase tracking-[0.2em] text-sbh-sand mb-8 text-center md:text-left">Nous Trouver</h4>
            ...
            <div className="flex flex-col items-center md:items-start reveal-on-scroll" style={{ transitionDelay: '300ms' }}>
                 <h4 className="font-sans text-sm font-bold uppercase tracking-[0.2em] text-sbh-sand mb-8 text-center md:text-left">Newsletter</h4>
                 <p className="font-sans text-base text-sbh-green/80 mb-8 leading-relaxed text-center md:text-left">
                    Recevez nos actualités confidentielles et nos nouvelles propriétés en avant-première.
                 </p>
        ...
        <div className="border-t border-sbh-green/10 pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left reveal-on-scroll" style={{ transitionDelay: '400ms' }}>
            <div className="flex flex-col gap-2">
                <p className="font-sans text-[10px] uppercase tracking-[0.2em] text-sbh-green/50">
                    &copy; {new Date().getFullYear()} Sun Beach House. All Rights Reserved.
                </p>
                <p className="font-sans text-[10px] tracking-widest text-sbh-green/30 hover:text-sbh-green/60 transition-colors flex items-center justify-center md:justify-start gap-1">
                    Made with <Heart size={10} fill="currentColor" className="text-sbh-terracotta/80" /> by <a href="https://www.kulturecom.fr" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Anthony PROFIT - www.kulturecom.fr</a>
                </p>
            </div>

            <div className="flex flex-wrap justify-center gap-8 font-sans text-[10px] uppercase tracking-[0.2em] text-sbh-green/50">
                <a href="#" className="hover:text-sbh-sand transition-colors duration-300">Mentions Légales</a>
                <a href="#" className="hover:text-sbh-sand transition-colors duration-300">Confidentialité</a>
