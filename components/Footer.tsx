                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-24">
                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-8 reveal-on-scroll">
                        ...
                        <div className="flex gap-4 pt-2 justify-center md:justify-start">
                            ...
                            <a href="https://share.google/TdUK2DyiWTMX9FF2A" target="_blank" rel="noopener noreferrer" aria-label="Retrouvez-nous sur Google Business" className="p-3 rounded-full border border-sbh-green/20 text-sbh-green hover:border-sbh-cream hover:text-sbh-cream hover:bg-white/5 transition-all duration-300 group touch-target">
