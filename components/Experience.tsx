    ...
    <section ref={sectionRef} className="relative md:h-[350vh] bg-sbh-green text-sbh-charcoal z-20">
      ...
      <div className="md:sticky md:top-0 md:h-screen w-full overflow-hidden flex flex-col md:flex-row items-start md:items-center">
        ...
        >
            ...
            <h2 className="font-serif text-6xl italic text-sbh-charcoal drop-shadow-sm text-center">Le Rythme de l'Île</h2>
            <p className="font-sans text-xs tracking-[0.3em] uppercase mt-4 text-sbh-charcoal/60 animate-bounce">Scroll to explore</p>
        </div>

        {/* Mobile Title */}
        <div className="md:hidden py-24 px-6 w-full text-center bg-sbh-green">
            <h2 className="font-serif text-3xl italic text-sbh-charcoal mb-4">Le Rythme de l'Île</h2>
