...
const nextConfig = {
    ...
    async redirects() {
        return [
            ...
            { source: '/fr/bien-a-louer/manoir-voltaire', destination: '/fr/villas/manoir-voltaire', permanent: true },
            { source: '/location/manoir-voltaire', destination: '/fr/villas/manoir-voltaire', permanent: true },
            { source: '/location/ti-manoir-voltaire', destination: '/fr/villas/manoir-voltaire', permanent: true },
            { source: '/rental/domaine-manoir-voltaire', destination: '/fr/villas/manoir-voltaire', permanent: true },
            { source: '/:lang(fr|en|es|pt)/villas/villa-manoir-voltaire-', destination: '/:lang/villas/manoir-voltaire', permanent: true },
