            ...
            },
            {
                ...
                headers: [
                    ...
                    },
                    {
                        ...
                        value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdn.sanity.io https://maps.googleapis.com https://*.googleapis.com https://va.vercel-scripts.com https://vercel.live; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: blob: https://cdn.sanity.io https://storage.googleapis.com https://images.unsplash.com https://image.mux.com https://maps.gstatic.com https://*.googleapis.com; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://*.sanity.io https://*.googleapis.com https://vitals.vercel-insights.com https://*.sanity.studio https://*.mux.com https://*.litix.io; media-src 'self' blob: https://*.mux.com; frame-src 'self' https://player.mux.com https://vercel.live https://*.sanity.studio; worker-src 'self' blob:;"
                    }
                ],
            },
        ]
