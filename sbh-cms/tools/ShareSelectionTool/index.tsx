                        ...
                        <Box style={{ backgroundColor: '#fff', borderRadius: '8px', overflow: 'hidden', border: '1px solid #e5e7eb' }}>
                            <Box padding={4}>
                                ...
                                <Box marginTop={5} style={{ textAlign: 'left' }}>
                                    <img src={`${process.env.SANITY_STUDIO_PREVIEW_URL || 'http://localhost:3000'}/signature.png`} alt="Signature Sun Beach House" style={{ width: '180px', height: 'auto', display: 'block', margin: '0' }} />
                                </Box>
                            </Box>
                        </Box>
                    </Card>
